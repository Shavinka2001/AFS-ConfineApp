...
const AdminDashboard = () => {
  ...
  const StatCard = ({ icon: Icon, title, value, change, color, bgColor }) => (
    <div className="bg-white rounded-2xl shadow-lg p-4 md:p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-200">
      ...
      <div className="flex items-start gap-3 md:gap-4">
        ...
        <div className={`p-3 md:p-4 rounded-xl ${bgColor} shadow-md flex-shrink-0 min-h-[44px] min-w-[44px] flex items-center justify-center`}>
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xl md:text-2xl lg:text-3xl font-bold text-[#232249] leading-tight">
            {value}
          </p>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-4 space-y-4 md:space-y-8">
      {/* Header */}
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between bg-white rounded-2xl shadow-xl p-4 md:p-6 border border-gray-100">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="bg-white rounded-2xl shadow-lg p-4 md:p-8 border border-gray-100 hover:shadow-xl transition-shadow duration-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4">
            <a
              href="/locations"
              className="flex items-center space-x-3 p-3 md:p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-100 hover:shadow-md transition-all duration-200 group min-h-[44px] active:scale-95"
            >
            ...
            <a
              href="/admin/users"
              className="flex items-center space-x-3 p-3 md:p-4 bg-gradient-to-r from-emerald-50 to-green-50 rounded-xl border border-emerald-100 hover:shadow-md transition-all duration-200 group min-h-[44px] active:scale-95"
            >
            ...
            <a
              ...
              className="flex items-center space-x-3 p-3 md:p-4 bg-gradient-to-r from-purple-50 to-violet-50 rounded-xl border border-purple-100 hover:shadow-md transition-all duration-200 group min-h-[44px] active:scale-95"
            >
