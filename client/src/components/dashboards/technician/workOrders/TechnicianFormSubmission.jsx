...
const TechnicianFormSubmission = ({ onSubmit, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-3xl shadow-2xl max-w-6xl max-h-[95vh] overflow-hidden w-full border border-gray-200">
        {/* Modern Header */}
          ...
          <div className="relative flex items-center justify-between text-white">
            <div className="flex items-center space-x-6">
              ...
              <div>
                ...
                <p className="text-white/80 text-lg">Submit confined space inspection details</p>
              </div>
            </div>
            <button
              onClick={onClose}
              className="p-3 hover:bg-white/20 rounded-2xl transition-all duration-300 group border border-white/20"
            >
        ...
        {/* Form Content */}
        <form onSubmit={handleSubmit} className="p-8 space-y-8 overflow-y-auto max-h-[75vh] bg-gradient-to-br from-gray-50/50 to-white">
          {/* Basic Information */}
          <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
            <div className="flex items-center mb-6">
              <div className="p-3 bg-gradient-to-br from-[#232249] to-[#232249]/80 rounded-2xl mr-4">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-2xl font-bold text-gray-900">Images & Documentation</h3>
            </div>
          ...
          <div className="flex justify-end space-x-4 pt-6">
            <button
              type="button"
              onClick={onClose}
              className="px-8 py-4 text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-2xl font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg"
            >
              Cancel
            </button>
            <button
              ...
              className="px-8 py-4 bg-gradient-to-r from-[#232249] to-[#232249]/90 text-white rounded-2xl font-semibold hover:shadow-xl transition-all duration-300 transform hover:scale-105 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2"
            >
              {isSubmitting ? (
                <>
