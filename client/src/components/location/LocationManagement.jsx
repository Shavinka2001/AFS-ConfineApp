              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="flex space-x-2">
                  <button
                    ...
                    className="group flex items-center space-x-2 px-5 py-2.5 bg-[#232249] text-white rounded-lg hover:bg-[#1a1a37] transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 font-semibold text-sm"
                  >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="group bg-white p-5 rounded-xl border border-gray-200 hover:border-[#232249]/30 hover:shadow-lg transition-all duration-300">
                <div className="flex items-center justify-between mb-3">
                  <div className="w-12 h-12 bg-[#232249] rounded-lg flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
              ...
              <div className="group bg-white p-5 rounded-xl border border-gray-200 hover:border-[#232249]/30 hover:shadow-lg transition-all duration-300">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="text-right">
                    <p className="text-3xl font-bold text-[#232249]">{locations.filter(l => l.status === 'active').length}</p>
                  </div>
                </div>
              ...
              <div className="group bg-white p-5 rounded-xl border border-gray-200 hover:border-[#232249]/30 hover:shadow-lg transition-all duration-300">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="text-right">
                    <p className="text-3xl font-bold text-[#232249]">{locations.filter(l => l.assignedTechnician?.isActive).length}</p>
                  </div>
                </div>
              ...
              <div className="group bg-white p-5 rounded-xl border border-gray-200 hover:border-[#232249]/30 hover:shadow-lg transition-all duration-300">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="text-right">
                    <p className="text-3xl font-bold text-[#232249]">{Object.values(buildings).reduce((sum, b) => sum + (b?.length || 0), 0)}</p>
                  </div>
                </div>
        ...
        {loading ? (
          <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-12 hover:shadow-xl transition-all duration-300">
            <div className="flex flex-col items-center justify-center space-y-4">
              <div className="relative">
                <div className="w-16 h-16 bg-[#232249] rounded-xl flex items-center justify-center shadow-lg">
          ...
          <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      <div className="flex items-center space-x-3 mb-3">
                        <div className="w-10 h-10 bg-[#232249] rounded-lg flex items-center justify-center shadow-md">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <button
                          ...
                          className="flex items-center space-x-1.5 px-3 py-1.5 bg-[#232249] text-white rounded-lg hover:bg-[#1a1a37] transition-all duration-200 font-semibold text-xs shadow-md hover:shadow-lg"
                        >
                          <span>Manage</span>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between mb-3">
                        ...
                        {location.assignedTechnician?.isActive ? (
                          ...
                          <button
                            ...
                            className="p-1.5 text-[#232249] hover:text-[#1a1a37] hover:bg-gray-50 rounded-lg transition-all duration-200"
                      ...
                      {location.assignedTechnician?.isActive ? (
                        <div className="p-4 bg-gray-50 border border-gray-200 rounded-lg">
                          <div className="flex items-start justify-between mb-3">
                            <div className="flex items-center space-x-2">
                              <div className="w-8 h-8 bg-[#232249] rounded-lg flex items-center justify-center shadow-md">
                                <UserCheck className="h-4 w-4 text-white" />
                              </div>
                              <div>
                                <h5 className="font-bold text-[#232249] text-sm">{location.assignedTechnician.name}</h5>
                                <p className="text-xs text-gray-600">{location.assignedTechnician.email}</p>
                              </div>
                            </div>
                            <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-bold bg-gray-100 text-[#232249] border border-gray-200">
                              Active
                            </span>
                          </div>
                          
                          {location.assignedTechnician.phone && (
                            <div className="flex items-center space-x-1.5 text-xs text-gray-700 mb-2">
                        ...
                        <div className="text-center py-6 bg-gray-50 rounded-lg border-2 border-dashed border-gray-200">
                          ...
                          <button
                            onClick={() => handleAssignTechnician(location)}
                            className="inline-flex items-center space-x-1.5 px-3 py-1.5 bg-[#232249] text-white rounded-lg hover:bg-[#1a1a37] transition-all duration-200 font-semibold text-xs shadow-md hover:shadow-lg"
                          >
            ...
            {locations.length === 0 && (
              <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-12 hover:shadow-xl transition-all duration-300">
                <div className="text-center space-y-4">
                  <div className="w-20 h-20 bg-[#232249] rounded-xl flex items-center justify-center mx-auto shadow-lg">
                  ...
                  <div>
                    ...
                    <button
                      onClick={handleCreateLocation}
                      className="inline-flex items-center space-x-2 px-6 py-3 bg-[#232249] text-white rounded-lg hover:bg-[#1a1a37] transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105 font-semibold text-base"
                    >
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-3">
                ...
                <button
                  ...
                  className="flex items-center space-x-2 px-4 py-2 bg-[#232249] text-white rounded-lg hover:bg-[#1a1a37] disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-105 font-semibold text-sm"
                >
                  <span>Next</span>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl border border-gray-200 p-8 max-w-md w-full mx-4 hover:shadow-3xl transition-all duration-300">
            <div className="flex justify-between items-center mb-6">
              <div className="flex items-center space-x-3">
                <div className="w-12 h-12 bg-[#232249] rounded-xl flex items-center justify-center shadow-lg">
                  <Users className="h-6 w-6 text-white" />
                </div>
            ...
            <div className="space-y-3 max-h-64 overflow-y-auto">
              {(technicians || []).filter(tech => !locations.some(loc => loc.assignedTechnician?.technicianId === tech._id && loc.assignedTechnician?.isActive)).map((technician) => (
                ...
                >
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="font-semibold text-[#232249] group-hover:text-[#1a1a37] transition-colors">
